...
import re
import pandas as pd
import War_fake_news_news_labeling as fake_detector
...
from constants import (
    CHANGES3_ACTOR,
    CHANGES3_CAUSE_OF_DEATH,
    CHANGES3_DATE_OF_DEATH,
    CHANGES3_PLACE_OF_DEATH,
    CHANGES3_NAME_OF_CASUALTY_OR_GROUP,
    
    CHANGES_AGGRESSIVE_ACTOR,
    CHANGES_AGGRESSIVE_CAUSE_OF_DEATH,
    CHANGES_AGGRESSIVE_DATE_OF_DEATH,
    CHANGES_AGGRESSIVE_PLACE_OF_DEATH,
    CHANGES_AGGRESSIVE_NAME_OF_CASUALTY_OR_GROUP,
    
    TOPICS_NAME_OF_CASUALTY_OR_GROUP,
    TOPICS_GENDER_OR_AGE_GROUP,
    TOPICS_CAUSE_OF_DEATH,
    TOPICS_TYPE,
    TOPICS_ACTOR,
    TOPICS_PLACE_OF_DEATH,
    TOPICS_DATE_OF_DEATH,
    testing_dictionary,
)
...
CHANGES3 = [
    ['actor', CHANGES3_ACTOR],
    ['cause of death', CHANGES3_CAUSE_OF_DEATH],
    ['date of death', CHANGES3_DATE_OF_DEATH],
    ['place of death', CHANGES3_PLACE_OF_DEATH],
    ['name of casualty or group', CHANGES3_NAME_OF_CASUALTY_OR_GROUP]
]

CHANGES_AGGRESSIVE = [
    ['Actor', CHANGES_AGGRESSIVE_ACTOR],
    ['Cause of death', CHANGES_AGGRESSIVE_CAUSE_OF_DEATH],
    ['Date of death', CHANGES_AGGRESSIVE_DATE_OF_DEATH],
    ['Place of death', CHANGES_AGGRESSIVE_PLACE_OF_DEATH],
    ['Name of casualty or group', CHANGES_AGGRESSIVE_NAME_OF_CASUALTY_OR_GROUP]
]

TOPICS = [
    ["Name of casualty or group", TOPICS_NAME_OF_CASUALTY_OR_GROUP],
    ["Gender or age group", TOPICS_GENDER_OR_AGE_GROUP],
    ["Cause of death", TOPICS_CAUSE_OF_DEATH],
    ["Type", TOPICS_TYPE],
    ["Actor", TOPICS_ACTOR],
    ["Place of death", TOPICS_PLACE_OF_DEATH],
    ["Date of death", TOPICS_DATE_OF_DEATH]
]
...
def change_articles(articles_with_facts, name_of_the_model, size_of_sample=5, change_of_article = "paraphrase", print_comments = False, testing=False):
    """
    Summary
...
def extract_and_change_articles_with_labeling_added(true_articles, name_of_the_model, size_of_sample=5, type_of_generation = "normal", change_of_article = "paraphrase_abdul", print_comments = False, testing=False):
    """
    Summary
            ...
            for json_dict in json_list:
                ...
                while quality_of_generation == False and number_of_trials <= 3:
                    ...
                    if not changed_article or not changed_json:
                        ...
                        labeling_result = fake_detector.fake_detect_only_for_one_example(extracted, print_comments=print_comments, testing=testing)
